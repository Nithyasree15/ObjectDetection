                ...
                if scores[0,index] > 0.95:
                    if ret == True:
                        ...
                        if old_frame is not None:
                            ...
                            if score < 0.60:
                                account_sid = 'ACde2f663cb19b9d96467071f2df9bdb6a'
                                auth_token = 'b9a9b7825c1abc4a6a5349857401ae06'
...
for i in range(len(image_np)):
                        for j in range(len(image_np[i])):
                            for k in range(len(image_np[i][j])):
                                if image_np[i][j][k] == previous_frame[i][j][k]:
